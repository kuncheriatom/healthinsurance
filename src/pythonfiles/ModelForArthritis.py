...
# Now, data will contain only columns with fewer than 250,0000 missing values.
...
#Feature Engineering for Arthritis
...
features = ['X_age65yr', 'X_age80', 'X_drdxar1', 'X_frt16', 'X_fruitex',
       'X_hispanc', 'X_incomg', 'X_lmtact1', 'X_pastrng', 'X_rfhype5',
         'fc60_', 'maxvo2_', 'physhlth', 'X_bmi5', 'drvisits',
       'poorhlth', 'X_llcpwt']   
target_variable = 'havarth3' 
target = df[target_variable]
# Identify numeric and non-numeric columns
