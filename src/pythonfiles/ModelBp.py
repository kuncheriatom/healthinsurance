...
# %%
df['bphigh4'] = df['bphigh4'].replace({
    'Told borderline or pre-hypertensive': 'pre hypertensive',
...
features = ['X_age80', 'maxvo2_', 'fc60_', 'X_bmi5', 'weight2', 'X_llcpwt', 'X_psu', 'X_ststr', 'X_vegesum',
       'drvisits', 'X_wt2rake']
