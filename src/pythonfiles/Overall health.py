...
# %%
#Feature Engg for Overall Health Analysis
...
features = ['physhlth', 'poorhlth', 'menthlth', 'X_bmi5', 'drvisits',
       'maxvo2_', 'fc60_',  'X_llcpwt', 'X_ststr',
       'sleptim1', 'X_age80', 'X_drnkmo4',  'X_strwt', 'X_vegesum']
target_variable = 'X_rfhlth' 
target = df[target_variable]
# Identify numeric and non-numeric columns
numeric_features = df[features].select_dtypes(include=np.number).columns
...
model_filename = 'overallhealth_model.sav'
